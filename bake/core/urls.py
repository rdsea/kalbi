...
urlpatterns = [
   ...
   path(r"apps/", views.AppListView.as_view()),
   path(r"apps/<pk>/", views.AppDetailView.as_view()),
   ...
   path(r"tools/<pk>/work_with", views.ToolWorkWithView.as_view()),
   path(r"tools/<pk>/conflict_with", views.ToolConflictWithView.as_view()),
   ...
   path(r"releashing_channels/", views.ReleasingChannelListView.as_view()),
   path(r"releashing_channels/<pk>/", views.ReleasingChannelDetailView.as_view()),
