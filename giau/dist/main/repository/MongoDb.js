...
class MongoDb {
    ...
    createConnection() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let mongoDBLocalAddress = this.config.mongoDBURL;
            if (testing) {
                this.mongoClient = yield mongodb_1.MongoClient.connect(`mongodb://${mongoDBLocalAddress}/edgeblockchain-test`, { useNewUrlParser: true });
                this.db = this.mongoClient.db('edgeblockchain-test');
            }
            else if (dev) {
                this.mongoClient = yield mongodb_1.MongoClient.connect(`mongodb://${mongoDBLocalAddress}/edgeblockchain`, { useNewUrlParser: true });
