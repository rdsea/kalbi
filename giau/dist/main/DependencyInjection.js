...
class DependencyInjection {
    ...
    createGraphAPI() {
        ...
        this.graphAPI = new Neo4jAPI_1.Neo4jAPI(this.createLogger(), this.createConfigurationWrapper());
        return this.graphAPI;
    }
    ...
    createExperimentService() {
        ...
        this.experimentService = new ExperimentService_1.ExperimentService(this.createExperimentRepository(), this.createTopologyService(), this.createBenchmarkService(), this.createDeploymentPatternService(), this.createDeploymentPatternMatcher(), this.createLogger());
        return this.experimentService;
    }
    ...
    createMongoDB() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.mongoDb = new MongoDb_1.MongoDb(this.logger, this.createConfigurationWrapper());
            return this.mongoDb;
        });
    }
    createLogger() {
