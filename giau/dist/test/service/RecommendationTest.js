...
describe('RecommendationService tests', () => {
    ...
    let deploymentPatternMatcher = null;
    ...
    it('findMostSimilarDeploymentPatternShouldReturnNull', () => __awaiter(this, void 0, void 0, function* () {
        let mostSimilar = yield deploymentPatternMatcher.findSimilarDeploymentPattern(createDeploymentPatternLarge1().structure);
    ...
    it('findMostSimilarDeploymentPatternShouldReturnPatternEqual', () => __awaiter(this, void 0, void 0, function* () {
        ...
        let mostSimilar = yield deploymentPatternMatcher.findSimilarDeploymentPattern(createDeploymentPatternSmall1().structure);
        assert(mostSimilar._id == small1._id);
        mostSimilar = yield deploymentPatternMatcher.findSimilarDeploymentPattern(createDeploymentPatternSmall2().structure);
        assert(mostSimilar._id == small2._id);
        mostSimilar = yield deploymentPatternMatcher.findSimilarDeploymentPattern(createDeploymentPatternSmall3().structure);
        assert(mostSimilar._id == small3._id);
        mostSimilar = yield deploymentPatternMatcher.findSimilarDeploymentPattern(createDeploymentPatternLarge1().structure);
        assert(mostSimilar._id == large1._id);
        mostSimilar = yield deploymentPatternMatcher.findSimilarDeploymentPattern(createDeploymentPatternLarge2().structure);
        assert(mostSimilar._id == large2._id);
        mostSimilar = yield deploymentPatternMatcher.findSimilarDeploymentPattern(createDeploymentPatternLarge3().structure);
    ...
    it('findMostSimilarDeploymentPatternShouldReturnSimilar', () => __awaiter(this, void 0, void 0, function* () {
        ...
        let mostSimilar = yield deploymentPatternMatcher.findSimilarDeploymentPattern(structure);
        assert(mostSimilar);
        assert(mostSimilar._id == small3._id);
    }));
});
