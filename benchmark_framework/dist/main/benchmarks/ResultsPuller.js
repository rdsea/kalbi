...
class ResultsPuller {
    ...
    copyLogsFromVM(node) {
        return __awaiter(this, void 0, void 0, function* () {
            if (node.resourceType != types_1.ResourceType.VEHICLE_IOT) { // we have logs only in vehicles
                return;
            }
    ...
    copyResultsFromVM(node) {
        return __awaiter(this, void 0, void 0, function* () {
            if (node.resourceType != types_1.ResourceType.VEHICLE_IOT) { // simulations are done only at vehicles
                return;
            }
