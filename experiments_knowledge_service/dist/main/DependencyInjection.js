...
class DependencyInjection {
    ...
    createRecommendationService() {
        ...
        this.recommendationService = new RecommendationService_1.RecommendationService(this.createDeploymentPatternService(), this.createExperimentService(), this.createLogger());
        return this.recommendationService;
    }
